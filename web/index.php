            ...
            case 'message_new':
                ...
                if (($text[0] == '/info') || ($text[0] == '/Info') || ($text[0] == '/инфо') || ($text[0] == '/Инфо') || ($text[0] == '/') || ($text[0] == '/') || ($text[0] == '/инфа') || ($text[0] == '/Инфа')) {
                    $request_params['message'] = "&#129302;Music status for Vk by kos v1.0.0\n\n"
                        ...
                        . "&#10024;Операции статуса:\n"
                        . "&#127761off - резкое выключить статус (то что вы слушали останется в статусе)\n"
                        ...
                        . "&#129316;В разработке: вывод обложки трека в спецаильный альбом, подключение к YouTube и другим сервисам";
